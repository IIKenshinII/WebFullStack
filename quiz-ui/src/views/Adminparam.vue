<template>
  <div>
    <div class="paddingright">
      <button type="button" class="btn btn-primary text-nowrap " @click="this.$router.push('/NewQuestion')">Ajouter une
        question</button><br />
      ...
      <button type="button" class="btn btn-primary text-nowrap " style="color:red;background-color:paleturquoise;"
